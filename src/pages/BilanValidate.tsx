...
export default function BilanValidate() {
  ...
  const toggleRegion = (regionId: string) => {
    setBilanData((prev) => {
      ...
      const newRegions = regions.includes(regionId) ? regions.filter((r) => r !== regionId) : [...regions, regionId];
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#F5F5DC]">
        <Card>
          <CardContent className="pt-6">
            ...
            <Button variant="outline" onClick={() => navigate("/dashboard")} className="mt-4 w-full">
              Retour au dashboard
            </Button>
          </CardContent>
        </Card>
      ...
      <main className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-8">
          <div className="flex-1">
            ...
            <h1 className="text-3xl sm:text-4xl font-black text-gray-800">Bilan kiné</h1>
            <p className="text-gray-600 mt-2">Complétez et modifiez le formulaire généré par l'IA</p>
          </div>
          ...
          <div className="lg:col-span-2 xl:col-span-2 flex flex-col gap-6">
            ...
            <Card className="border-gray-200">
              ...
              <CardContent className="space-y-6">
                {/* Section Bio */}
                <div>
                  <h3 className="text-lg font-bold text-[#8B9D83] pb-3 border-b border-gray-200 mb-4">Bio</h3>
                ...
                <div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        updateField("donneesCliniques.habitudesVie.sommeilAlimentationActivite", e.target.value)
                      }
          ...
          <div className="lg:col-span-3 xl:col-span-1 flex flex-col gap-6">
            ...
            <Card className="border-gray-200">
              ...
              <CardContent className="space-y-3">
                ...
                <label className="flex items-center gap-3 cursor-pointer">
                  <Checkbox
                    checked={bilanData.facteursPsycho?.deprime || false}
                    onCheckedChange={(checked) => updateField("facteursPsycho.deprime", checked)}
                  />
                  <span className="text-base font-medium">Déprime</span>
                </label>

                <label className="flex items-center gap-3 cursor-pointer">
                  <Checkbox
                    checked={bilanData.facteursPsycho?.surmenage || false}
                    onCheckedChange={(checked) => updateField("facteursPsycho.surmenage", checked)}
                  />
                  <span className="text-base font-medium">Surmenage</span>
                </label>
